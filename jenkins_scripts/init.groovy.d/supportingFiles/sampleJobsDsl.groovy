...
folder(sampleJobsDir) {
   description("""<p>This sample folder contains a collection of basic Hello-World-esque Jenkins jobs to demonstrate
                  ...
                  |href="mailto:DOCPF_Leads@local.com">DOCPF_Leads@local.com</a>.</p>""".stripMargin())
}
   ...
   pipelineJob("${sampleJobsDir}/${jobName}") {
      ...
      parameters {
         ...
         if (jobName != 'sloc') {
            ...
            stringParam('BITBUCKET_URL', 'https://localhost.com:8443/bitbucket/scm/devp/devops-pipelines.git', 'For BITBUCKET only: URL of BitBucket repo containing the source code to be counted.')
      ...
      definition {
         cpsScm {
               scm {
                  git {
                     remote {
                        url("https://localhost.com:8443/bitbucket/scm/devp/${repoName}.git")
                     }
